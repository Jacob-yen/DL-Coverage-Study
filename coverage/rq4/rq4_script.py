...
if __name__ == "__main__":
    ...
    dataset_network_dir = os.path.join(root_dir, rq4_path, console_args.exp_date, dataset_network)
    common_utils.create_path(sa_intermedia_path, idc_intermedia_path, rq4_path, dataset_network_dir)
    ...
    for sample_idx in console_args.sample_indices:
        ...
        for rid in range(console_args.repeat_times):
            ...
            sampling_row = [f"sample{sample_idx}_repeat_{rid}",
