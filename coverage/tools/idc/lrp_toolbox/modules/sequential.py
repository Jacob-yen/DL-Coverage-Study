...
class Sequential(Module):
    ...
    def lrp(self,R,lrp_var=None,param=None,subject_layer=None):
        '''
        ...
        temporary data
        '''
        # if we have no subject_layer
        # we calculate R for all layers
        # else we calculate for the subject_layer
        ...
        if subject_layer is None:
            ...
            for m in self.modules[subject_layer:][::-1]:
                R = m.lrp(R,lrp_var,param)
                all_layer_relevances.append(R)
